...
import (
	...
	pb "github.com/zhangkun/etcd-example/loadbalance/cmd/helloworld"
	grpclb "github.com/zhangkun/etcd-example/loadbalance/etcdv3"
)

var (
	svc  = flag.String("service", "hello_service", "service name")
	host = flag.String("host", "10.151.3.8", "listening host")
	port = flag.String("port", "60001", "listening port")
	reg  = flag.String("reg", "http://10.151.3.8:2379", "register etcd address")
)
